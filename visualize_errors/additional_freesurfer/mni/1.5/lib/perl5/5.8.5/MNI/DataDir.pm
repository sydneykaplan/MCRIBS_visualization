...
that you're currently reading about is F</usr/pubsw/packages/mni/1.4/data>.
...
would look for F</usr/pubsw/packages/mni/1.4/data/autoreg>.  If this directory isn't
...
my $default_dir = '/usr/pubsw/packages/mni/1.4/data';
