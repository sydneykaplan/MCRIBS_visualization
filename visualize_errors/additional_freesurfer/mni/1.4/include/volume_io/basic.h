...
@VERSION    : $Header: /software/source/minc/volume_io/Include/volume_io/basic.h,v 1.33.2.2 2005/03/31 17:39:48 bert Exp $
---------------------------------------------------------------------------- */
...
//the next typedef is commented-out to address the gcc warning: "useless 
// keyword or type name in empty declaration"
//if its needed, just use 'VIO_Status' instead of 'Status'
