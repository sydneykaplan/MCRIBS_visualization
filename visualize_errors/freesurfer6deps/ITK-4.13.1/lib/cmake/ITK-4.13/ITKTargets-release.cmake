...
set_target_properties(ITKDeprecated PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libITKDeprecated-4.13.so.1"
  IMPORTED_SONAME_RELEASE "libITKDeprecated-4.13.so.1"
  )

list(APPEND _IMPORT_CHECK_TARGETS ITKDeprecated )
list(APPEND _IMPORT_CHECK_FILES_FOR_ITKDeprecated "${_IMPORT_PREFIX}/lib/libITKDeprecated-4.13.so.1" )
...
set_target_properties(itkopenjpeg PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libitkopenjpeg-4.13.so.1"
  IMPORTED_SONAME_RELEASE "libitkopenjpeg-4.13.so.1"
  )

list(APPEND _IMPORT_CHECK_TARGETS itkopenjpeg )
list(APPEND _IMPORT_CHECK_FILES_FOR_itkopenjpeg "${_IMPORT_PREFIX}/lib/libitkopenjpeg-4.13.so.1" )
...
set_target_properties(ITKReview PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libITKReview-4.13.so.1"
  IMPORTED_SONAME_RELEASE "libITKReview-4.13.so.1"
  )

list(APPEND _IMPORT_CHECK_TARGETS ITKReview )
list(APPEND _IMPORT_CHECK_FILES_FOR_ITKReview "${_IMPORT_PREFIX}/lib/libITKReview-4.13.so.1" )
