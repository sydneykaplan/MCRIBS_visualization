...
# define itksys_AUTO_PTR_REF 0
# define itksys_AUTO_PTR_CONST const
# define itksys_AUTO_PTR_CAST(a) cast(a)
#else
# define itksys_AUTO_PTR_REF 1
# define itksys_AUTO_PTR_CONST
# define itksys_AUTO_PTR_CAST(a) a
#endif
...
public:
  ...
  template <class Y>
  auto_ptr(auto_ptr<Y> itksys_AUTO_PTR_CONST& a) throw():
    x_(itksys_AUTO_PTR_CAST(a).release())
    {
    }
  ...
  template <class Y>
  auto_ptr& operator=(auto_ptr<Y> itksys_AUTO_PTR_CONST& a) throw()
    {
    this->reset(itksys_AUTO_PTR_CAST(a).release());
    return *this;
    }
  ...
  /** Construct from another auto_ptr holding an object of the same
      ...
      auto_ptr.  */
  auto_ptr(auto_ptr itksys_AUTO_PTR_CONST& a) throw():
    x_(itksys_AUTO_PTR_CAST(a).release())
    {
    }
  ...
  auto_ptr& operator=(auto_ptr itksys_AUTO_PTR_CONST& a) throw()
    {
    this->reset(itksys_AUTO_PTR_CAST(a).release());
    return *this;
    }
