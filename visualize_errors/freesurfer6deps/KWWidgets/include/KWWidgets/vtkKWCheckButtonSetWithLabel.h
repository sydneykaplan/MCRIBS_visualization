...
=========================================================================*/
// .NAME vtkKWCheckButtonSetWithLabel - a vtkKWCheckButtonSet associated to a vtkKWLabel
// .SECTION Description
// This class creates a composite widget associating a vtkKWCheckButtonSet to a
// vtkKWLabel.
...
// implemented in this class is on the left of the vtkKWCheckButtonSet, but 
...
// the type vtkKWCheckButtonSet. Classes related to the same template can be found
// in the \ref kwwidgets_autogenerated_widget_with_label_group section.
// .SECTION See Also
// vtkKWWidgetWithLabel vtkKWCheckButtonSet

#ifndef __vtkKWCheckButtonSetWithLabel_h
#define __vtkKWCheckButtonSetWithLabel_h

#include "vtkKWWidgetWithLabel.h"

class vtkKWCheckButtonSet;

class KWWidgets_EXPORT vtkKWCheckButtonSetWithLabel : public vtkKWWidgetWithLabel
{
public:
  static vtkKWCheckButtonSetWithLabel* New();
  vtkTypeRevisionMacro(vtkKWCheckButtonSetWithLabel, vtkKWWidgetWithLabel);
  void PrintSelf(ostream& os, vtkIndent indent);

  // Description:
  // Get the vtkKWCheckButtonSet that is being labeled
  virtual vtkKWCheckButtonSet* GetWidget();
...
protected:
  ...
  // Description:
  // Internal widget
  vtkKWCheckButtonSet *Widget;

private:

  vtkKWCheckButtonSetWithLabel(const vtkKWCheckButtonSetWithLabel&); // Not implemented
  void operator=(const vtkKWCheckButtonSetWithLabel&); // Not implemented
};
