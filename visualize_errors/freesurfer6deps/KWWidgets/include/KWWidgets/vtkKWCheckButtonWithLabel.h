...
=========================================================================*/
// .NAME vtkKWCheckButtonWithLabel - a vtkKWCheckButton associated to a vtkKWLabel
// .SECTION Description
// This class creates a composite widget associating a vtkKWCheckButton to a
// vtkKWLabel.
...
// implemented in this class is on the left of the vtkKWCheckButton, but 
...
// .SECTION See Also
// vtkKWWidgetWithLabel vtkKWCheckButton

#ifndef __vtkKWCheckButtonWithLabel_h
#define __vtkKWCheckButtonWithLabel_h

#include "vtkKWWidgetWithLabel.h"

class vtkKWCheckButton;

class KWWidgets_EXPORT vtkKWCheckButtonWithLabel : public vtkKWWidgetWithLabel
{
public:
  static vtkKWCheckButtonWithLabel* New();
  vtkTypeRevisionMacro(vtkKWCheckButtonWithLabel, vtkKWWidgetWithLabel);
...
private:
  ...
  vtkKWCheckButtonWithLabel(const vtkKWCheckButtonWithLabel&); // Not implemented
  void operator=(const vtkKWCheckButtonWithLabel&); // Not implemented
};
