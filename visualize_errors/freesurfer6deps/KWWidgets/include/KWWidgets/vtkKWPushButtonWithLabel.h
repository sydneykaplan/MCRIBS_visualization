...
=========================================================================*/
// .NAME vtkKWPushButtonWithLabel - a vtkKWPushButton associated to a vtkKWLabel
// .SECTION Description
// This class creates a composite widget associating a vtkKWPushButton to a
// vtkKWLabel.
...
// implemented in this class is on the left of the vtkKWPushButton, but 
...
#ifndef __vtkKWPushButtonWithLabel_h
#define __vtkKWPushButtonWithLabel_h

#include "vtkKWWidgetWithLabel.h"

class vtkKWPushButton;

class KWWidgets_EXPORT vtkKWPushButtonWithLabel : public vtkKWWidgetWithLabel
{
public:
...
private:
  ...
  vtkKWPushButtonWithLabel(const vtkKWPushButtonWithLabel&); // Not implemented
  void operator=(const vtkKWPushButtonWithLabel&); // Not implemented
};
