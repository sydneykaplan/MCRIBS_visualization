...
=========================================================================*/
// .NAME vtkKWMultiColumnListWithLabel - a vtkKWMultiColumnList associated to a vtkKWLabel
// .SECTION Description
// This class creates a composite widget associating a vtkKWMultiColumnList to a
// vtkKWLabel.
...
// implemented in this class is on the left of the vtkKWMultiColumnList, but 
...
// .SECTION See Also
// vtkKWWidgetWithLabel vtkKWMultiColumnList

#ifndef __vtkKWMultiColumnListWithLabel_h
#define __vtkKWMultiColumnListWithLabel_h

#include "vtkKWWidgetWithLabel.h"

class vtkKWMultiColumnList;

class KWWidgets_EXPORT vtkKWMultiColumnListWithLabel : public vtkKWWidgetWithLabel
{
public:
  static vtkKWMultiColumnListWithLabel* New();
  vtkTypeRevisionMacro(vtkKWMultiColumnListWithLabel, vtkKWWidgetWithLabel);
  void PrintSelf(ostream& os, vtkIndent indent);

  // Description:
  // Get the vtkKWMultiColumnList that is being labeled
...
private:
  ...
  vtkKWMultiColumnListWithLabel(const vtkKWMultiColumnListWithLabel&); // Not implemented
  void operator=(const vtkKWMultiColumnListWithLabel&); // Not implemented
};
