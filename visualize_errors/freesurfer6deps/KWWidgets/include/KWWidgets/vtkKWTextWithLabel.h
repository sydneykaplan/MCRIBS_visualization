...
=========================================================================*/
// .NAME vtkKWTextWithLabel - a vtkKWText associated to a vtkKWLabel
// .SECTION Description
// This class creates a composite widget associating a vtkKWText to a
// vtkKWLabel.
...
// implemented in this class is on the left of the vtkKWText, but 
...
// .SECTION See Also
// vtkKWWidgetWithLabel vtkKWText

#ifndef __vtkKWTextWithLabel_h
#define __vtkKWTextWithLabel_h

#include "vtkKWWidgetWithLabel.h"

class vtkKWText;

class KWWidgets_EXPORT vtkKWTextWithLabel : public vtkKWWidgetWithLabel
{
public:
  static vtkKWTextWithLabel* New();
  vtkTypeRevisionMacro(vtkKWTextWithLabel, vtkKWWidgetWithLabel);
  void PrintSelf(ostream& os, vtkIndent indent);

  // Description:
  // Get the vtkKWText that is being labeled
...
private:
  ...
  vtkKWTextWithLabel(const vtkKWTextWithLabel&); // Not implemented
  void operator=(const vtkKWTextWithLabel&); // Not implemented
};
