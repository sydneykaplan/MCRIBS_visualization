...
=========================================================================*/
// .NAME vtkKWLoadSaveButtonWithLabel - a vtkKWLoadSaveButton associated to a vtkKWLabel
// .SECTION Description
// This class creates a composite widget associating a vtkKWLoadSaveButton to a
// vtkKWLabel.
...
// implemented in this class is on the left of the vtkKWLoadSaveButton, but 
...
// the type vtkKWLoadSaveButton. Classes related to the same template can be found
// in the \ref kwwidgets_autogenerated_widget_with_label_group section.
// .SECTION See Also
// vtkKWWidgetWithLabel vtkKWLoadSaveButton

#ifndef __vtkKWLoadSaveButtonWithLabel_h
#define __vtkKWLoadSaveButtonWithLabel_h

#include "vtkKWWidgetWithLabel.h"

class vtkKWLoadSaveButton;

class KWWidgets_EXPORT vtkKWLoadSaveButtonWithLabel : public vtkKWWidgetWithLabel
{
public:
  static vtkKWLoadSaveButtonWithLabel* New();
  vtkTypeRevisionMacro(vtkKWLoadSaveButtonWithLabel, vtkKWWidgetWithLabel);
  void PrintSelf(ostream& os, vtkIndent indent);

  // Description:
  // Get the vtkKWLoadSaveButton that is being labeled
  virtual vtkKWLoadSaveButton* GetWidget();
...
protected:
  ...
  // Description:
  // Internal widget
  vtkKWLoadSaveButton *Widget;

private:

  vtkKWLoadSaveButtonWithLabel(const vtkKWLoadSaveButtonWithLabel&); // Not implemented
  void operator=(const vtkKWLoadSaveButtonWithLabel&); // Not implemented
};
