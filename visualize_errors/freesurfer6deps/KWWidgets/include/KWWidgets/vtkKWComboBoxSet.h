...
class KWWidgets_EXPORT vtkKWComboBoxSet : public vtkKWWidgetSet
{
public:
  static vtkKWComboBoxSet* New();
  vtkTypeRevisionMacro(vtkKWComboBoxSet,vtkKWWidgetSet);
...
private:
  vtkKWComboBoxSet(const vtkKWComboBoxSet&); // Not implemented
  void operator=(const vtkKWComboBoxSet&); // Not implemented
};
