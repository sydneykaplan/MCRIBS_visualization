...
=========================================================================*/
// .NAME vtkKWListBoxWithScrollbarsWithLabel - a vtkKWListBoxWithScrollbars associated to a vtkKWLabel
// .SECTION Description
// This class creates a composite widget associating a vtkKWListBoxWithScrollbars to a
// vtkKWLabel.
...
// implemented in this class is on the left of the vtkKWListBoxWithScrollbars, but 
...
// the type vtkKWListBoxWithScrollbars. Classes related to the same template can be found
// in the \ref kwwidgets_autogenerated_widget_with_label_group section.
// .SECTION See Also
// vtkKWWidgetWithLabel vtkKWListBoxWithScrollbars

#ifndef __vtkKWListBoxWithScrollbarsWithLabel_h
#define __vtkKWListBoxWithScrollbarsWithLabel_h

#include "vtkKWWidgetWithLabel.h"

class vtkKWListBoxWithScrollbars;

class KWWidgets_EXPORT vtkKWListBoxWithScrollbarsWithLabel : public vtkKWWidgetWithLabel
{
public:
  static vtkKWListBoxWithScrollbarsWithLabel* New();
  vtkTypeRevisionMacro(vtkKWListBoxWithScrollbarsWithLabel, vtkKWWidgetWithLabel);
  void PrintSelf(ostream& os, vtkIndent indent);

  // Description:
  // Get the vtkKWListBoxWithScrollbars that is being labeled
  virtual vtkKWListBoxWithScrollbars* GetWidget();
...
private:
  ...
  vtkKWListBoxWithScrollbarsWithLabel(const vtkKWListBoxWithScrollbarsWithLabel&); // Not implemented
  void operator=(const vtkKWListBoxWithScrollbarsWithLabel&); // Not implemented
};
