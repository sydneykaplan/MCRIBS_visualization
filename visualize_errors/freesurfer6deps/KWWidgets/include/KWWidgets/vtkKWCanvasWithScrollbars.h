...
class KWWidgets_EXPORT vtkKWCanvasWithScrollbars : public vtkKWWidgetWithScrollbars
{
public:
  static vtkKWCanvasWithScrollbars* New();
...
private:
  vtkKWCanvasWithScrollbars(const vtkKWCanvasWithScrollbars&); // Not implemented
  void operator=(const vtkKWCanvasWithScrollbars&); // Not implemented
};
