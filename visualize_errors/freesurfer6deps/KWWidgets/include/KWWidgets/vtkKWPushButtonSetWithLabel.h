...
=========================================================================*/
// .NAME vtkKWPushButtonSetWithLabel - a vtkKWPushButtonSet associated to a vtkKWLabel
// .SECTION Description
// This class creates a composite widget associating a vtkKWPushButtonSet to a
// vtkKWLabel.
...
// implemented in this class is on the left of the vtkKWPushButtonSet, but 
...
// the type vtkKWPushButtonSet. Classes related to the same template can be found
// in the \ref kwwidgets_autogenerated_widget_with_label_group section.
// .SECTION See Also
// vtkKWWidgetWithLabel vtkKWPushButtonSet

#ifndef __vtkKWPushButtonSetWithLabel_h
#define __vtkKWPushButtonSetWithLabel_h

#include "vtkKWWidgetWithLabel.h"

class vtkKWPushButtonSet;

class KWWidgets_EXPORT vtkKWPushButtonSetWithLabel : public vtkKWWidgetWithLabel
{
public:
...
private:
  ...
  vtkKWPushButtonSetWithLabel(const vtkKWPushButtonSetWithLabel&); // Not implemented
  void operator=(const vtkKWPushButtonSetWithLabel&); // Not implemented
};
