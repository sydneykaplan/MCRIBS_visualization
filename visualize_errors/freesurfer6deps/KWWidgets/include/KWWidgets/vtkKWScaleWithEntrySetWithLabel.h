...
=========================================================================*/
// .NAME vtkKWScaleWithEntrySetWithLabel - a vtkKWScaleWithEntrySet associated to a vtkKWLabel
// .SECTION Description
// This class creates a composite widget associating a vtkKWScaleWithEntrySet to a
// vtkKWLabel.
...
// implemented in this class is on the left of the vtkKWScaleWithEntrySet, but 
...
// the type vtkKWScaleWithEntrySet. Classes related to the same template can be found
// in the \ref kwwidgets_autogenerated_widget_with_label_group section.
// .SECTION See Also
// vtkKWWidgetWithLabel vtkKWScaleWithEntrySet

#ifndef __vtkKWScaleWithEntrySetWithLabel_h
#define __vtkKWScaleWithEntrySetWithLabel_h

#include "vtkKWWidgetWithLabel.h"

class vtkKWScaleWithEntrySet;

class KWWidgets_EXPORT vtkKWScaleWithEntrySetWithLabel : public vtkKWWidgetWithLabel
{
public:
  static vtkKWScaleWithEntrySetWithLabel* New();
  vtkTypeRevisionMacro(vtkKWScaleWithEntrySetWithLabel, vtkKWWidgetWithLabel);
  void PrintSelf(ostream& os, vtkIndent indent);

  // Description:
  // Get the vtkKWScaleWithEntrySet that is being labeled
  virtual vtkKWScaleWithEntrySet* GetWidget();
...
protected:
  ...
  // Description:
  // Internal widget
  vtkKWScaleWithEntrySet *Widget;

private:

  vtkKWScaleWithEntrySetWithLabel(const vtkKWScaleWithEntrySetWithLabel&); // Not implemented
  void operator=(const vtkKWScaleWithEntrySetWithLabel&); // Not implemented
};
