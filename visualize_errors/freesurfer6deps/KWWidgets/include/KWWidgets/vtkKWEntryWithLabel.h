...
=========================================================================*/
// .NAME vtkKWEntryWithLabel - a vtkKWEntry associated to a vtkKWLabel
// .SECTION Description
// This class creates a composite widget associating a vtkKWEntry to a
// vtkKWLabel.
...
// implemented in this class is on the left of the vtkKWEntry, but 
...
// .SECTION See Also
// vtkKWWidgetWithLabel vtkKWEntry

#ifndef __vtkKWEntryWithLabel_h
#define __vtkKWEntryWithLabel_h

#include "vtkKWWidgetWithLabel.h"

class vtkKWEntry;

class KWWidgets_EXPORT vtkKWEntryWithLabel : public vtkKWWidgetWithLabel
{
public:
  static vtkKWEntryWithLabel* New();
  vtkTypeRevisionMacro(vtkKWEntryWithLabel, vtkKWWidgetWithLabel);
  void PrintSelf(ostream& os, vtkIndent indent);

  // Description:
  // Get the vtkKWEntry that is being labeled
  virtual vtkKWEntry* GetWidget();
...
private:
  ...
  vtkKWEntryWithLabel(const vtkKWEntryWithLabel&); // Not implemented
  void operator=(const vtkKWEntryWithLabel&); // Not implemented
};
