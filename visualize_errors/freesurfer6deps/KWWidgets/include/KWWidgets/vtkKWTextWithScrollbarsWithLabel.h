...
=========================================================================*/
// .NAME vtkKWTextWithScrollbarsWithLabel - a vtkKWTextWithScrollbars associated to a vtkKWLabel
// .SECTION Description
// This class creates a composite widget associating a vtkKWTextWithScrollbars to a
// vtkKWLabel.
...
// implemented in this class is on the left of the vtkKWTextWithScrollbars, but 
...
// the type vtkKWTextWithScrollbars. Classes related to the same template can be found
// in the \ref kwwidgets_autogenerated_widget_with_label_group section.
// .SECTION See Also
// vtkKWWidgetWithLabel vtkKWTextWithScrollbars

#ifndef __vtkKWTextWithScrollbarsWithLabel_h
#define __vtkKWTextWithScrollbarsWithLabel_h

#include "vtkKWWidgetWithLabel.h"

class vtkKWTextWithScrollbars;

class KWWidgets_EXPORT vtkKWTextWithScrollbarsWithLabel : public vtkKWWidgetWithLabel
{
public:
  static vtkKWTextWithScrollbarsWithLabel* New();
  vtkTypeRevisionMacro(vtkKWTextWithScrollbarsWithLabel, vtkKWWidgetWithLabel);
  void PrintSelf(ostream& os, vtkIndent indent);

  // Description:
  // Get the vtkKWTextWithScrollbars that is being labeled
  virtual vtkKWTextWithScrollbars* GetWidget();
...
protected:
  ...
  // Description:
  // Internal widget
  vtkKWTextWithScrollbars *Widget;

private:

  vtkKWTextWithScrollbarsWithLabel(const vtkKWTextWithScrollbarsWithLabel&); // Not implemented
  void operator=(const vtkKWTextWithScrollbarsWithLabel&); // Not implemented
};
