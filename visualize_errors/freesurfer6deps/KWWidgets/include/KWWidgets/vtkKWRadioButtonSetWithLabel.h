...
=========================================================================*/
// .NAME vtkKWRadioButtonSetWithLabel - a vtkKWRadioButtonSet associated to a vtkKWLabel
// .SECTION Description
// This class creates a composite widget associating a vtkKWRadioButtonSet to a
// vtkKWLabel.
...
// implemented in this class is on the left of the vtkKWRadioButtonSet, but 
...
// the type vtkKWRadioButtonSet. Classes related to the same template can be found
// in the \ref kwwidgets_autogenerated_widget_with_label_group section.
// .SECTION See Also
// vtkKWWidgetWithLabel vtkKWRadioButtonSet

#ifndef __vtkKWRadioButtonSetWithLabel_h
#define __vtkKWRadioButtonSetWithLabel_h

#include "vtkKWWidgetWithLabel.h"

class vtkKWRadioButtonSet;

class KWWidgets_EXPORT vtkKWRadioButtonSetWithLabel : public vtkKWWidgetWithLabel
{
public:
...
private:
  ...
  vtkKWRadioButtonSetWithLabel(const vtkKWRadioButtonSetWithLabel&); // Not implemented
  void operator=(const vtkKWRadioButtonSetWithLabel&); // Not implemented
};
