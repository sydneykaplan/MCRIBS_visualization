...
=========================================================================*/
// .NAME vtkKWMessageWithLabel - a vtkKWMessage associated to a vtkKWLabel
// .SECTION Description
// This class creates a composite widget associating a vtkKWMessage to a
// vtkKWLabel.
...
// implemented in this class is on the left of the vtkKWMessage, but 
...
// the type vtkKWMessage. Classes related to the same template can be found
// in the \ref kwwidgets_autogenerated_widget_with_label_group section.
// .SECTION See Also
// vtkKWWidgetWithLabel vtkKWMessage

#ifndef __vtkKWMessageWithLabel_h
#define __vtkKWMessageWithLabel_h

#include "vtkKWWidgetWithLabel.h"

class vtkKWMessage;

class KWWidgets_EXPORT vtkKWMessageWithLabel : public vtkKWWidgetWithLabel
{
public:
  static vtkKWMessageWithLabel* New();
  vtkTypeRevisionMacro(vtkKWMessageWithLabel, vtkKWWidgetWithLabel);
  void PrintSelf(ostream& os, vtkIndent indent);

  // Description:
  // Get the vtkKWMessage that is being labeled
  virtual vtkKWMessage* GetWidget();
...
private:
  ...
  vtkKWMessageWithLabel(const vtkKWMessageWithLabel&); // Not implemented
  void operator=(const vtkKWMessageWithLabel&); // Not implemented
};
