...
=========================================================================*/
// .NAME vtkKWPopupButtonWithLabel - a vtkKWPopupButton associated to a vtkKWLabel
// .SECTION Description
// This class creates a composite widget associating a vtkKWPopupButton to a
// vtkKWLabel.
...
// implemented in this class is on the left of the vtkKWPopupButton, but 
...
// the type vtkKWPopupButton. Classes related to the same template can be found
// in the \ref kwwidgets_autogenerated_widget_with_label_group section.
// .SECTION See Also
// vtkKWWidgetWithLabel vtkKWPopupButton

#ifndef __vtkKWPopupButtonWithLabel_h
#define __vtkKWPopupButtonWithLabel_h

#include "vtkKWWidgetWithLabel.h"

class vtkKWPopupButton;

class KWWidgets_EXPORT vtkKWPopupButtonWithLabel : public vtkKWWidgetWithLabel
{
public:
  static vtkKWPopupButtonWithLabel* New();
  vtkTypeRevisionMacro(vtkKWPopupButtonWithLabel, vtkKWWidgetWithLabel);
  void PrintSelf(ostream& os, vtkIndent indent);

  // Description:
  // Get the vtkKWPopupButton that is being labeled
...
private:
  ...
  vtkKWPopupButtonWithLabel(const vtkKWPopupButtonWithLabel&); // Not implemented
  void operator=(const vtkKWPopupButtonWithLabel&); // Not implemented
};
