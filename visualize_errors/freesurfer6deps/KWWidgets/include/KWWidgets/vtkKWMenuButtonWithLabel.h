...
=========================================================================*/
// .NAME vtkKWMenuButtonWithLabel - a vtkKWMenuButton associated to a vtkKWLabel
// .SECTION Description
...
// implemented in this class is on the left of the vtkKWMenuButton, but 
...
#ifndef __vtkKWMenuButtonWithLabel_h
#define __vtkKWMenuButtonWithLabel_h

#include "vtkKWWidgetWithLabel.h"

class vtkKWMenuButton;

class KWWidgets_EXPORT vtkKWMenuButtonWithLabel : public vtkKWWidgetWithLabel
{
public:
...
private:
  ...
  vtkKWMenuButtonWithLabel(const vtkKWMenuButtonWithLabel&); // Not implemented
  void operator=(const vtkKWMenuButtonWithLabel&); // Not implemented
};
