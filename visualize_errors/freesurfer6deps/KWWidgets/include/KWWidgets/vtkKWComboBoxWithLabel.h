...
=========================================================================*/
// .NAME vtkKWComboBoxWithLabel - a vtkKWComboBox associated to a vtkKWLabel
// .SECTION Description
// This class creates a composite widget associating a vtkKWComboBox to a
// vtkKWLabel.
...
// implemented in this class is on the left of the vtkKWComboBox, but 
...
// .SECTION See Also
// vtkKWWidgetWithLabel vtkKWComboBox

#ifndef __vtkKWComboBoxWithLabel_h
#define __vtkKWComboBoxWithLabel_h

#include "vtkKWWidgetWithLabel.h"

class vtkKWComboBox;

class KWWidgets_EXPORT vtkKWComboBoxWithLabel : public vtkKWWidgetWithLabel
{
public:
  static vtkKWComboBoxWithLabel* New();
  vtkTypeRevisionMacro(vtkKWComboBoxWithLabel, vtkKWWidgetWithLabel);
  void PrintSelf(ostream& os, vtkIndent indent);

  // Description:
  // Get the vtkKWComboBox that is being labeled
  virtual vtkKWComboBox* GetWidget();
...
protected:
  ...
  // Description:
  // Internal widget
  vtkKWComboBox *Widget;

private:

  vtkKWComboBoxWithLabel(const vtkKWComboBoxWithLabel&); // Not implemented
  void operator=(const vtkKWComboBoxWithLabel&); // Not implemented
};
