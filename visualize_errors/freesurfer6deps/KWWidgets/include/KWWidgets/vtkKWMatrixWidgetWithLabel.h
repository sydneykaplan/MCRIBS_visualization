...
=========================================================================*/
// .NAME vtkKWMatrixWidgetWithLabel - a vtkKWMatrixWidget associated to a vtkKWLabel
// .SECTION Description
// This class creates a composite widget associating a vtkKWMatrixWidget to a
// vtkKWLabel.
...
// implemented in this class is on the left of the vtkKWMatrixWidget, but 
...
// the type vtkKWMatrixWidget. Classes related to the same template can be found
// in the \ref kwwidgets_autogenerated_widget_with_label_group section.
// .SECTION See Also
// vtkKWWidgetWithLabel vtkKWMatrixWidget

#ifndef __vtkKWMatrixWidgetWithLabel_h
#define __vtkKWMatrixWidgetWithLabel_h

#include "vtkKWWidgetWithLabel.h"

class vtkKWMatrixWidget;

class KWWidgets_EXPORT vtkKWMatrixWidgetWithLabel : public vtkKWWidgetWithLabel
{
public:
  static vtkKWMatrixWidgetWithLabel* New();
  vtkTypeRevisionMacro(vtkKWMatrixWidgetWithLabel, vtkKWWidgetWithLabel);
  void PrintSelf(ostream& os, vtkIndent indent);

  // Description:
  // Get the vtkKWMatrixWidget that is being labeled
  virtual vtkKWMatrixWidget* GetWidget();
...
protected:
  ...
  // Description:
  // Internal widget
  vtkKWMatrixWidget *Widget;

private:

  vtkKWMatrixWidgetWithLabel(const vtkKWMatrixWidgetWithLabel&); // Not implemented
  void operator=(const vtkKWMatrixWidgetWithLabel&); // Not implemented
};
